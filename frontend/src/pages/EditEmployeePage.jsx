...
export default function EditEmployeePage() {
  ...
  const scoreStyle = getScoreStyle(form?.performanceScore || 0);
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          ...
          <p className="text-gray-500 mt-1 text-sm">Update employee information for <strong>{form?.name}</strong></p>
        </div>
